...
var $addNewItem = $('<a href="#" class="btn btn-info my-2" style="float: right">Ajouter vehicule</a>');
// when the page is loaded and ready
$(document).ready(function () {
    // get the collectionHolder, initilize the var by getting the list;
    $collectionHolder = $('#ensured_Vehicles');
    // append the add new item link to the collectionHolder
    $('#form_top').append($addNewItem);
...
function addNewForm() {
    ...
    var $panel = $('<div class="panel panel-warning ml-auto col-8 my-2 p-3 border rounded border-primary" id="form_vehicle"><div class="panel-heading"></div></div>');
...
function addRemoveButton($panel) {
    ...
    var $removeButton = $('<a href="#" class="btn btn-danger btn-block">Supprimer</a>');
    ...
    $removeButton.click(function (e) {
        ...
        if (countForms > 1) {
            ...
            $(e.target).parents('.panel').slideUp(300, function () {
                $(this).remove();
            });
            countForms--;
        }
