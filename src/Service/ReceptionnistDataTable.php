...
class ReceptionnistDataTable extends AbstractDataTableHandler
{
    const ID = "agent";
    protected $doctrine;
    protected $router;
    ...
    public function handle(DataTableQuery $request): DataTableResults
    {
        ...
        $query->select('i.id', 'i.insurerId', 'i.firstName', 'i.lastName', 'i.phoneNumber', 'i.email')
            ->where(' i.roles LIKE :role')
            ->setParameter('role', '%ROLE_RECEPTIONIST%');
